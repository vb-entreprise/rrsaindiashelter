/*
  ...
  This migration sets up the core database structure for the RRSA India NGO management system.
  
  1. Tables
    - Authentication and authorization tables (users, roles, permissions)
    - Case management tables (case_papers)
    - Operations tables (feeding_records, cleaning_records)
    - Inventory management tables (inventory_items, inward/outward inventory)
    - Activity logging (activity_logs)
    
  2. Enums
    - animal_type_enum: dog, cat, bird, other
    - gender_enum: male, female, unknown
    - status_enum: active, discharged, deceased
    - inventory_category_enum: food, medicine, equipment, supplies, other
    
  3. Default Data
    - Roles: admin, doctor, staff, volunteer
    - Default admin user
