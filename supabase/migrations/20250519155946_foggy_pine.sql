/*
  # Fix UUID consistency in database schema
  
  1. Changes
    - Changed all ID columns to use UUID type for consistency
    - Updated foreign key references to match UUID type
    - Maintained all existing table structures and relationships
    - Preserved all RLS policies and triggers
