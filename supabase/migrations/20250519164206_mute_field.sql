/*
  ...
  1. Schema Changes
    ...
    - Added DROP TABLE statements with IF EXISTS
    - Updated foreign key constraints
    - Added proper timestamps with timezone
...
DROP TABLE IF EXISTS outward_inventory;
DROP TABLE IF EXISTS inward_inventory;
DROP TABLE IF EXISTS inventory_items;
DROP TABLE IF EXISTS cleaning_records;
DROP TABLE IF EXISTS feeding_records;
DROP TABLE IF EXISTS case_papers;
...
DROP TYPE IF EXISTS animal_type_enum;
