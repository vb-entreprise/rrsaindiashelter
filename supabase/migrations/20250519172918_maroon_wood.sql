/*
  # Complete Database Schema Rewrite

  1. Schema Overview
    - User Management (users, roles, permissions)
    - Animal Management (case papers, feeding records, cleaning records)
    - Inventory Management (items, inward/outward records)
    - Activity Logging
...
-- Create case_paper created_by trigger function
...
BEGIN
    ...
    -- Add trigger for case_paper created_by
...
CREATE INDEX IF NOT EXISTS idx_role_user_user_role ON role_user(user_id, role_id);